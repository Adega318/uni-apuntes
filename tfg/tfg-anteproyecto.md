...
Adicionalmente, el sistema podrá implementar la capacidad de imitación de voces basándose en grabaciones, esta adición permitirá la incorporación de una galería de voces pregreneradas para su uso.
