...
### ID3
El proceso de creación de árbol con ID3 se basa en el concepto de entropía, se seleccionan las distintas características y se calcula las entropías producidas al separarlas , el cálculo de la entropía es la suma ponderada de las varianzas $(\log_{2}(casosA/casosB))$ de las clases creadas.
### C4.5
